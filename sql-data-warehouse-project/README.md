...
Welcome — this folder contains the SQL Data Warehouse implementation (ETL, DDL, and data models).

This project focuses on data engineering: building Bronze → Silver → Gold layers, managing schemas, and preparing analytical-ready tables for downstream reporting.

---
## 🏗️ Data Architecture

The data architecture for this project follows Medallion Architecture **Bronze**, **Silver**, and **Gold** layers:
![Data Architecture](docs/Data_Architechture.jpg)
